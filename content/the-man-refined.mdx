---
title: 'TheManRefined'
abstract: TheManRefined is an independent menswear retailer specializing in making high-quality, custom-made garments that don't break the bank.
...
- My Account Pages (Overview, Orders, Wishlist, Payment Info)
- Login, Logout & Forgot Password Pages Ecommerce Transactional Email Templates (Account Registration, Lost Password, Order Confirmation, Order Shipped, Gift Certificate)
